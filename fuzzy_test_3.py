...
cap = cv2.VideoCapture("/home/veerav/PycharmProjects/fuzzy/Cup/img/%04d.jpg")
...
cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(alldata, 8, 2, error=0.05, maxiter=10, init=None)## u is fuzzy partition matrix
...
while(1):
    ...
    if ret == True:
        ...
        i =0
        for y1 in range(y2 - 5, y2 + 5):
            j=0
            for x1 in range(x2 - 5, x2 + 5):
                clone = frame.copy()
