...
cap = cv2.VideoCapture("/home/veerav/PycharmProjects/fuzzy/Ball_ce2/img/%04d.jpg")
...
while(1):
    ...
    if ret == True:
        ...
        for y1 in range(y2 - 100, y2 + 100,20):
            j=0
            for x1 in range(x2 - 100, x2 +100,20):
                if (x1< frame.shape[1] and y1 < frame.shape[0]):
                    clone = frame.copy()
